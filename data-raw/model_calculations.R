...
print(lubridate::now())
# saveRDS(flattenDataPackModel_21(cop_data), file = paste0(output_location,"model_data_pack_input_22_20220105_1_flat.rds"))
# saveRDS(cop_data, file = paste0(output_location,"model_data_pack_input_22_20220105_1.rds"))
...
# cop_data_old <- readRDS(file = paste0(output_location,"model_data_pack_input_22_20220105_1.rds"))
# deltas = data.frame()
