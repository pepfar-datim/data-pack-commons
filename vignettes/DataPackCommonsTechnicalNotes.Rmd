...
The the final R object created by this script is called data. When written as an RDS, these are the data used by data packr to populat the PSNUxIM tab.

## Generating configuration files

There are three important configuration files, excel sheets, that are used to co
...
* Modify GetData_DataPack to use datimutils::getAnalytics instead of internal getData_Analytics
    * I started on this in this [branch](https://github.com/pepfar-datim/data-pack-commons/tree/refactor-GetData_DataPack , but it was almost 2 years ago.)
